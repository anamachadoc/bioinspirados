...
class GeneticAlgorithm():
  def __init__(self, **kwargs):
    ...
    self.population = [Individual(individual, **self.config_individual) for individual in [np.random.randint(2, size=(self.config_individual['n_parameters'], self.config_individual['n_bits'])) for _ in range(self.n_pop)]]
    self.population_aux = []
